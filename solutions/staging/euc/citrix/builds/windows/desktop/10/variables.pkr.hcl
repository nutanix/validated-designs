...
variable "nutanix_os_iso_name" {
  ...
  default = "Nutanix_NVD_DaaS_Windows_10"
}
...
variable "os_installer_image_enterprise" {
  type    = string
  description = "Selects Windows 10 Enterprise in the editions menu. Required by Sysprep for building the image"
  default = "Windows 10 Enterprise" # DO NOT CHANGE
}
