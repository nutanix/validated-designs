...
source "nutanix" "windows-desktop-enterprise" {
  ...
  cd_content = {
    "Autounattend.xml" = templatefile("${abspath(path.root)}/data/autounattend.pkrtpl.hcl", {
      ...
      os_installer_image    = "Windows 10 Enterprise"
      os_installer_kms_key  = var.win10_kms_key_enterprise
...
build {
  ...
  provisioner "ansible" {
    ...
    extra_arguments = [
      ...
      "--extra-vars",
      "citrix_vda_desktop_installer_url=${var.citrix_vda_desktop_installer_url}"
    ]
  }
